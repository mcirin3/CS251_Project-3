// barchartanimate.h
// The BarChartAnimate class collecets BarChart objects
// in an array along with other variables that define the content.
// This would be each chart's title, xlabel, and sources. This class 
// contains functions that handle reading data from a given file. The data that 
//is collected and stored to the charts, is then animated by looping through the
// BarCharts type array to create an animation of charts. The animate part is being given 
//a constant amount of data when executed.

// barchart.h
// BarChart class contains private member variables, a pointer
// to an array of type Bar. The array contains Bars that are from
// using the Bar class and pushed on the barchart array to form a chart.
// There are other private member variables that define the chart like
// size, capacity and current frame. There are also functions that debug our
// input such as dump, and a graph function which shows given input in sorted order.
// The graph function also includes appropriate coloring as well.
